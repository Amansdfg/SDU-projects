...
public class StudentGradeBookApplicattion{
        ...
        if (LogIn()){
            ...
            do{
                ...
                switch (option){
                    ...
                    case 2:manageRecords();break;
                    case 3:calculateGrades();break;
                    case 4:viewStatistics();break;
                    case 5:generateReports();break;
                    case 6:deleteStudent();break;
                    case 7:logOutAndExit();break;
                    default:System.out.println("Enter number between 1 - 7 (including).");
                }
            }while(option!=7);
        }
    }
    ...
    public static void deleteStudent(){
        ...
        for (int i = 0; i < id.length; i++){
            if (name[i] != null && id[i] == idForDeleteStudent && idForDeleteStudent>0){
                name[i] = null;
                id[i] = 0;
                score[i] = 0;
                grade[i] = ' ';
